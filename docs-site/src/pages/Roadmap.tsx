    ...
    services: [
      {
        ...
        aws: 'Amazon S3',
        poc: 'poc-s3-storage',
        description: 'Object storage com CRUD, versionamento, presigned URLs, multipart upload, lifecycle, policies, CORS, notifications e website hosting.',
        phase: 'done',
        features: ['CRUD', 'Versioning', 'Presigned URLs', 'Multipart', 'Lifecycle', 'ACLs', 'CORS', 'Notifications', 'Website Hosting'],
      },
      {
        name: 'CloudFront',
    ...
    services: [
      {
        ...
        description: 'Filas de mensagens com standard queues, FIFO, dead-letter queues, visibility timeout e long polling.',
        phase: 'next',
        features: ['Standard Queue', 'FIFO', 'DLQ', 'Long Polling', 'Batch Operations'],
      },
      {
        name: 'SNS',
        aws: 'Amazon SNS',
